...
class PostSerializer(serializers.ModelSerializer):
    ...
    profile_image = serializers.CharField(source="user_id.profile_image", read_only=True)
...
class Post_KRSerializer(serializers.ModelSerializer):
    ...
    profile_image = serializers.CharField(source="post.user_id.profile_image", read_only=True)
